...
class SupplierOrdersController extends GetxController {
  ...
  // Supplier-specific status filter options
  List<OrderFulfillment> get supplierStatuses => [
  ...
  void showHelpDialog() {
    Get.dialog(
      AlertDialog(
        title: const Text('Supplier Orders Help'),
            ...
            children: [
              ...
              _buildHelpSection(
                ...
                [
                  ...
                  'Sort orders by date, reference, or total',
                ],
              ),
            ],
          ),
  ...
  void showFilterDialog() {
    ...
    final tempShowPaid = showPaid.value;
    final tempShowUnpaid = showUnpaid.value;
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              showPaid.value = dialogShowPaid.value;
              showUnpaid.value = dialogShowUnpaid.value;
