...
class SupplierOrdersView extends StatefulWidget {
  ...
  @override
  State<SupplierOrdersView> createState() => SupplierOrdersViewState();
}

class SupplierOrdersViewState extends State<SupplierOrdersView> {
  ...
  void _onOrderTap(OrderModel order) {
    Get.toNamed(AppRoutes.supplierOrderDetails, arguments: order.id);
  }
