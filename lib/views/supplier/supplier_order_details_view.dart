...
class SupplierOrderDetailsView extends StatefulWidget {
  final String orderId;

  const SupplierOrderDetailsView({
    Key? key,
    required this.orderId,
  }) : super(key: key);

  @override
  State<SupplierOrderDetailsView> createState() => SupplierOrderDetailsViewState();
}

class SupplierOrderDetailsViewState extends State<SupplierOrderDetailsView> {
  ...
  Widget _buildActionButtons() {
    ...
    if (_currentUser.isSupplier && order.fulfillment == OrderFulfillment.import) {
      return Padding(
